...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 infos">
        <div class="info-list">
            <div class="mb-3">
                <h2 style="color:#777d91;">BÁO CÁO LỊCH SỬ SỬA CHỮA</h2>
            ...
            <div class="px-4 mb-2 d-flex align-items-center justify-content-between">
                <form action="<c:url value='/exportRepairHistory'/>" method="get">
                    <button type="submit" class="btn-action">Xuất Excel</button>
                </form>
                <span id="day" class="fst-italic"></span>
            </div>
                        ...
                        <c:forEach var="history" items="${repairHistory}">
                            <c:if test="${history.equipmentId.id == equipment.id}">
                                <tr  class="text-center" style="cursor: pointer">
                                    ...
                                    <td>${history.equipmentId.name}</td>
