...
<h1 class="text-center mt-1" style="color:#777d91;">CHI TIẾT THIẾT BỊ</h1>
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 infos">
        <div class="info-list">
            ...
            <!-- Mã QR cho trang thiết bị -->
            <div class="qr-container text-center mt-3">
                <h4>Mã QR để truy cập trang thiết bị</h4>
                <img src="<c:url value='/equipment/${equipment.id}/qrcode'/>" alt="QR code for equipment" style="width: 200px; height: 200px;" />            </div>
        </div>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 infos">
        <div class="info-list">
            ...
            <div>
                ...
                <div class="border border-3 rounded-3 mb-2">
                    <c:choose>
                        <c:when test="${not empty latestMaintenance}">
                            <span class="info-item">
                                <p class="equip-item">Ngày bảo trì gần nhất:</p> ${latestMaintenance.maintenanceDate}
                            </span>
                            <span class="info-item">
                                <p class="equip-item">Lịch bảo trì:</p> ${latestMaintenance.maintenanceFrequency}
                            </span>
                            <span class="info-item">
                                <p class="equip-item">Loại bảo trì:</p> ${latestMaintenance.maintenanceType}
                            </span>
                            <span class="info-item">
                                <p class="equip-item">Kỹ thuật viên:</p> ${latestMaintenance.performedByUserId.fullName}
                            </span>
                        </c:when>
                        <c:otherwise>
                            <span class="info-item">
                                <p class="equip-item">Chưa có lịch bảo trì</p>
                            </span>
                        </c:otherwise>
                    </c:choose>
                </div>
