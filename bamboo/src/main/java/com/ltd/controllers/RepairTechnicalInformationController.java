...
public class RepairTechnicalInformationController {
    ...
    @GetMapping(value = "/equipment/repairhistory/{equipmentId}", produces = "text/html; charset=UTF-8")
    ...
    @PostMapping(value = "/equipment/repairhistory/{equipmentId}", produces = "text/html; charset=UTF-8")
    public String repairHistory(@PathVariable("equipmentId") int equipmentId,
        ...
        repairHistory.setPerformedByUserId(loggedInUser);
    ...
    @GetMapping(value = "/equipment/incident/{equipmentId}", produces = "text/html; charset=UTF-8")
    ...
    @PostMapping(value = "/equipment/incident/{equipmentId}", produces = "text/html; charset=UTF-8")
    ...
    @GetMapping(value = "/equipment/maintenanceschedule/{equipmentId}", produces = "text/html; charset=UTF-8")
    ...
    @PostMapping(value = "/equipment/maintenanceschedule/{equipmentId}", produces = "text/html; charset=UTF-8")
    public String maintenanceSchedule(@PathVariable("equipmentId") int equipmentId,
        ...
        Maintenanceschedule exitingMaintenanceSchedule = this.maintenanceScheduleService.findTopByEquipmentIdOrderByMaintenanceDateDesc(equipmentId);
        // Kiểm tra nếu đã có lịch bảo trì trước đó
        if (exitingMaintenanceSchedule != null) {
            // Nếu có lịch bảo trì trước đó, MaintenanceDate của lịch mới = NextMaintenanceDate của lịch cũ
            maintenanceSchedule.setMaintenanceDate(exitingMaintenanceSchedule.getNextMaintenanceDate());
        } else {
            // Nếu chưa có lịch bảo trì trước đó, MaintenanceDate = NextMaintenanceDate của lịch mới
    ...
    @GetMapping(value = "/equipment/devicehistories/{equipmentId}", produces = "text/html; charset=UTF-8")
