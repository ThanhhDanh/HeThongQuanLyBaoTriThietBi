...
public class InvoiceDetailsServiceImpl implements InvoiceDetailsService{
    ...
    @Override
    public long countTotalSoldEquipment() {
        return this.invoicedetailRepo.countTotalSoldEquipment();
    }

    @Override
    public void save(Invoicedetail invoice) {
        invoicedetailRepo.save(invoice);
    }

    @Override
    public List<Invoicedetail> findInvoiceDetailsByInvoiceId(int invoiceId) {
        return this.invoicedetailRepo.findInvoiceDetailsByInvoiceId(invoiceId);
    }
