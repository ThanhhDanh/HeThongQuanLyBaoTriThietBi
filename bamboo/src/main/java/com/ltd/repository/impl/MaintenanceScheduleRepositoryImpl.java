...
public class MaintenanceScheduleRepositoryImpl implements MaintenanceScheduleRepository {
    ...
    public List<Maintenanceschedule> getOverdueAndUpcomingSchedules() {
        ...
        // Tạo truy vấn để lấy các lịch bảo trì đã quá hạn và sắp đến hạn
        Query query = session.createQuery("FROM Maintenanceschedule ms WHERE ms.nextMaintenanceDate < :today OR ms.nextMaintenanceDate <= :upcomingDate");
