    ...
    <head>
        ...
        <style>
            ...
            * {
            ...
            .infos {
                background: linear-gradient(to top, rgba(10, 90, 170, 0.08), rgba(238, 238, 238, 0.07));
                border-right: 1px solid;
                border-image: -webkit-gradient(
                    linear,
                    left bottom,
                    left top,
                    from(rgba(60, 60, 60, 0.5)),
                    to(rgba(220, 220, 220, 0.4))
                    );
                border-image: linear-gradient(to top, rgba(60, 60, 60, 0.5), rgba(220, 220, 220, 0.4));
        ...
        <div class="wrapper">
            <aside id="sidebar">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item">
                        <a href="<c:url value="/listequipments?equipPage=1"/>" class="sidebar-link">
                    ...
                    <li class="sidebar-item position-relative">
                        <span class="badge" id="unread-count">${unreadCount}</span>
                        <a href="#" class="sidebar-link has-dropdown collapsed" data-bs-toggle="collapse" 
                           data-bs-target="#multi" aria-expanded="false"
                           aria-controls="multi">
                            <i class="${unreadCount == 0 ? 'notification-bell' : ''} fa-regular fa-bell"></i>
                            <span>Thông báo</span>
                        </a>
                        <ul id="multi" class="sidebar-dropdown notification-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                            <h6 class="my-2 text-light text-center">Thông báo hôm nay</h6>
                            <c:forEach items="${notifications}" var="notification">
                                <li class="sidebar-item notification-item mark-as-read-button ${notification.isRead ? 'read' : 'unread'}" 
                                    onclick="markAsRead(${notification.id})" 
                                    data-notification-id="${notification.id}">
                                    <p class="notification-title">Sự cố: ${notification.equipmentId.name}</p>
                                    <p class="notification-content">Nguyên nhân: ${notification.incidentDescription}</p>
                                    <p class="notification-status">${notification.isRead ? 'Đã đọc' : 'Chưa đọc'}</p>
                                    <i class="fa-solid fa-trash delete-notification"></i>
